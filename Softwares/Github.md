...
- 使用 [the Import a Repository feature](https://github.com/new/import) 拷贝 `https://github.com/USTC-CG/USTC_CG_26` 得到自己的**私有库** 
...
- 在库的本地根目录执行
  ...
  ```bash
  git remote add upstream https://github.com/USTC-CG/USTC_CG_26.git
